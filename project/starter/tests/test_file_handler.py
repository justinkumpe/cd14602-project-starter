...
class TestFileHandler:
    ...
    def test_load_corrupt_json_raises_runtime_error(self):
        """Corrupt JSON files should raise RuntimeError with context."""
        corrupt_path = self.temp_dir + "/bad.json"
        with open(corrupt_path, "w", encoding="utf-8") as file:
